        ...
        try {
            ...
            if (registros.length > 0) {
                ...
                for (const registro of registros) {
                    ...
                    tabla += `| ${registro.id.toString().slice(0,espacios_id - 1)}| ${registro.descripcion.toString().slice(0,espacios_descripcion-1)}| ${parseFloat(registro.precio_final).toFixed(2)}${parseFloat(registro.precio_final).toFixed(2).toString().padEnd(espacios_precio-1," ")}|\n`
                }
